...
export function Pomodoro() {
  const setPomodoroStatus = usePomodoroStore(
    (state) => state.setPomodoroStatus
  );
  ...
  const handleToggle = () => {
    ...
    setPomodoroStatus(
      isTicking ? PomodoroStatus.stopped : PomodoroStatus.ticking
    );
